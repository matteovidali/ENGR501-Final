...
class DPA(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "DPA")
        ...
        self.qtgui_time_sink_x_0.set_y_axis(-.05, .05)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/dev/stdout', True)
...
def main(top_block_cls=DPA, options=None):
